...
def mocker_mongodb_collection(mocker):
    ...
    def _mocker_delete_one(collection_name: str):
        return mocker.MagicMock(deleted_count=1)
    ...
    def _mocker_get_collection(collection_name: str):
        ...
        _collection.delete_one.return_value = _mocker_delete_one(collection_name)
        return _collection
